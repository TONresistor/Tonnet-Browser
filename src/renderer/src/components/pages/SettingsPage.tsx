...
const BookmarksSection = memo(function BookmarksSection({
  ...
  const [editingBookmark, setEditingBookmark] = useState<{ id: string; title: string; url: string; folderId: string | null } | null>(null)
  ...
  return (
    <div>
      <SectionHeader
        title="Bookmarks"
        description="Manage your saved sites with folders"
      />
      ...
      <div className="bg-card rounded-xl border border-border px-4 mb-6">
        ...
        <SettingRow
          ...
          description="Restore default bookmarks and folders"
        >
          <button
            onClick={onReset}
