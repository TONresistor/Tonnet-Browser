...
export const browserClient = {
  ...
  zoomIn: () => window.electron.zoomIn(),
  zoomOut: () => window.electron.zoomOut(),
  zoomReset: () => window.electron.zoomReset(),
  toggleDevTools: () => window.electron.toggleDevTools(),
  createTab: (tabId: string) => window.electron.tabs.create(tabId),
