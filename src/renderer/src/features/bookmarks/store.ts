...
import { bookmarksClient } from '@/features/bookmarks/client'
import { newId } from '@/lib/id'
import type { Bookmark, BookmarkFolder } from '@shared/ipc-contract/bookmarks'

export type { Bookmark, BookmarkFolder } from '@shared/ipc-contract/bookmarks'
...
export async function loadBookmarksFromMain(): Promise<void> {
  try {
    const data = await bookmarksClient.load()
