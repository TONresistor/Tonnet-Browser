...
| Platform | Download |
|----------|----------|
| **Windows** | [Installer](https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON.Browser.Setup.1.4.0.exe) · [Portable](https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON.Browser.1.4.0.exe) |
| **macOS** | [DMG (Universal)](https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON.Browser-1.4.0-universal.dmg) |
| **Linux** | [AppImage](https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON.Browser-1.4.0.AppImage) · [.deb](https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/ton-browser_1.4.0_amd64.deb) |

### Windows

Your browser may warn that the file is from an unknown source. Click **"Keep"** to download.

1. Download and run **TON.Browser.Setup.1.4.0.exe**
...
```powershell
irm https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON.Browser.Setup.1.4.0.exe -OutFile TonBrowser.exe; Unblock-File TonBrowser.exe; .\TonBrowser.exe
```
...
```bash
curl -LO https://github.com/TONresistor/tonnet-browser/releases/latest/download/TON.Browser-1.4.0-universal.dmg && hdiutil attach TON.Browser-1.4.0-universal.dmg && cp -R "/Volumes/TON Browser 1.4.0-universal/TON Browser.app" /Applications/ && hdiutil detach "/Volumes/TON Browser 1.4.0-universal" && xattr -cr /Applications/TON\ Browser.app && open /Applications/TON\ Browser.app
```
...
```bash
# AppImage
chmod +x TON.Browser-1.4.0.AppImage
./TON.Browser-1.4.0.AppImage

# Debian/Ubuntu
sudo dpkg -i ton-browser_1.4.0_amd64.deb
```
...
```bash
# AppImage
curl -LO https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON.Browser-1.4.0.AppImage && chmod +x TON.Browser-1.4.0.AppImage && ./TON.Browser-1.4.0.AppImage

# Debian/Ubuntu
curl -LO https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/ton-browser_1.4.0_amd64.deb && sudo dpkg -i ton-browser_1.4.0_amd64.deb
```
