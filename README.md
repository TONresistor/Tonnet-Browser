...
```bash
curl -LO https://github.com/TONresistor/Tonnet-Browser/releases/latest/download/TON-Browser-2.5.0-universal.dmg && hdiutil attach TON-Browser-2.5.0-universal.dmg && cp -R "/Volumes/TON Browser/TON Browser.app" /Applications/ && hdiutil detach "/Volumes/TON Browser" && xattr -cr /Applications/TON\ Browser.app && open /Applications/TON\ Browser.app
```
